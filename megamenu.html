...
<html lang="zxx">
<head>
	<title>Megamenu | Industrial - Industry and Engineering Services Template</title>
	<meta charset="utf-8" />
									...
									<div class="row">
										...
										<div class="col-sm-3">
											<ul>
												...
												<li><a href="testimonial-alter.html">Testimonial - Alter</a></li>
												<li><a href="careers.html">Career / Jobs</a></li>
										...
										<div class="col-sm-3">
											<ul>
												...
												<li><a href="projects-extend.html">Projects List - Extend</a></li>
										...
										<div class="col-sm-3">
											<ul>
												...
												<li><a href="contact-extend.html">Contact Us - Extend</a></li>
												<li><a href="get-a-quote.html">Get a Quote</a></li>
												<li><a href="error-404.html">Error 404</a></li>
												<li><a href="faqs.html">FAQ's Page</a></li>
												<li><a href="gallery.html">Gallery Page</a></li>
												<li><a href="carousel.html">Carousel Slide</a></li>
												<li><a href="typography.html">Typography Visual</a></li>
												<li><a href="megamenu.html">Megamenu Example</a></li>
											</ul>
										</div>
							...
							<ul class="dropdown-menu dropdown-megamenu">
								<li class="dropdown megamenu-container">
									<div class="row">
										...
										<div class="col-md-4 hidden-xs hidden-sm pos-fixed">
											<ul>
												<li>
													<div class="imagebg">
														<img alt="" src="image/megamenu.jpg">
													</div>
												</li>
											</ul>
										</div>
										...
										<div class="col-sm-12 col-md-8">
											<ul class="col-sm-4">
												<li class="megamenu-header">Mega Heading</li>
												<li><a href="#">Mega Submenu</a></li>
												<li><a href="#">Mega Submenu</a></li>
												<li><a href="#">Mega Submenu</a></li>
												<li><a href="#">Mega Submenu</a></li>
												<li><a href="#">Mega Submenu</a></li>
								...
								<li class="dropdown megamenu-container">
									<div class="row">
										...
										<div class="col-md-4 hidden-xs hidden-sm pos-fixed">
											<ul>
												<li>
													<div class="mega-text-block">
														<h3>About Industrial</h3>
														<p>Lorem ipsum dolor sit amet, vim rebum nostrum. Te vim justo recusabo recteque suas porro affert mea eros sonet vue.</p>
														<p><a href="about-us.html" class="btn">Learn More</a></p>
													</div>
												</li>
											</ul>
										</div>
