...
<html lang="zxx">
<head>
	<title>Error 404 | Industrial - Industry and Engineering Services Template</title>
	<meta charset="utf-8" />
		...
		<div class="container">
			<div class="row">
				<div class="404-content col-md-6 col-md-offset-3">
					<h1>404</h1>
					<p>OOPPS! THE PAGE YOU WERE LOOKING FOR, COULDN'T BE FOUND.</p>
					<p><a href="./"><em class="fa fa-angle-left"></em> Back to Home</a></p>
				</div>
			</div>
		</div>
	</div>
