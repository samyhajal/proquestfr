	    ...
	    <div class="container">
	        <div class="content row">
	        	...
	        	<div class="wide-md center">
	        		<h2 class="heading-section">Our Company Services</h2>
				...
				<div class="feature-row feature-service-row row">
					...
					<div class="col-md-4 col-sm-6 even">
						...
						<div class="feature boxed">
							...
							<div class="fbox-content">
								<h3><a href="solution-single.html">Material Science and Engineering</a></h3>
					...
					<div class="col-md-4 col-sm-6 odd">
						...
						<div class="feature boxed">
							...
							<div class="fbox-content">
								<h3><a href="solution-single-alter.html">Mechanical Engineering</a></h3>
