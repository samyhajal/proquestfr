...
<html lang="zxx">
<head>
	<title>Testimonial | Industrial - Industry and Engineering Services Template</title>
	<meta charset="utf-8" />
			...
			<div class="row">
				...
				<div class="row row-quotes">
					<div class="col-md-6">
						...
						<div class="quotes quotes-flat">
							<div class="quotes-text">
								<p>I was looking for an mining solution iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritati iste natus sit.</p>
							</div>
							<div class="profile">
								<h5>Newman H.</h5>
							</div>
						...
						<div class="quotes quotes-flat">
							<div class="quotes-text">
								<p>I was looking for best solution and iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritati totam rem.</p>
							</div>
							<div class="profile">
								<h5>Robert W.</h5>
								<h6>CEO, Company Name</h6>
					...
					<div class="col-md-6">
						...
						<div class="quotes quotes-flat">
							<div class="quotes-text">
								...
								<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis ciatis unde omnis iste natus.</p>
							</div>
							<div class="profile">
								<h5>Maribel M.</h5>
								<h6>CEO, Company Name</h6>
						...
						<div class="quotes quotes-flat">
							<div class="quotes-text">
								<p>Nemo enim ipsam ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam. Eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explic.</p>
							</div>
							<div class="profile">
								<h5>Jimmy Alan</h5>
							</div>
						...
						<div class="quotes quotes-flat">
							<div class="quotes-text">
								<p>Nemo enim ipsam ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium rem aperill.</p>
							</div>
							<div class="profile">
								<h5>Williams Jhon</h5>
							</div>
