...
<html lang="zxx">
<head>
	<title>Case Study | Industrial - Industry and Engineering Services Template</title>
	<meta charset="utf-8" />
		...
		<div class="container">
			<div class="content row">
				...
				<div class="case-details row">
					<div class="col-sm-12">
						<h2>The Solar Energy Difference</h2>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pretium orci sit amet mi ullamcorper egestas. Sed non mattis metus. Integer vel lorem tincidunt, pharetra eros nec, posuere odio. Nullam eget bibendum sem, venenatis lacinia justo pretium orci sit amet mi ullam.</p>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pretium orci sit amet mi ullamcorper egestas. Sed non mattis metus vel lorem tincidunt, pharetra eros nec Nullam eget bibendum. Consectetur adipiscing elit. Phasellus pretium orci sit amet mi ullamcorper egestas. Sed non mattis metus. </p>
					</div>
					<div class="gaps size-lg"></div>
					<div class="col-sm-6 res-m-bttm">
						<h3 class="heading">Installing the Solar</h3>
						<p><img src="image/photo-sm-energy-g.jpg" alt=""></p>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pretium orci sit amet mi ullamcorper egestas. Sed non mattis metus. Integer vel lorem tincidunt, pharetra eros nec, posuere odio. Nullam eget bibendum sem, venenatis lacinia justo pretium orci sit amet mi ullam.</p>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pretium orci sit amet mi ullamcorper egestas. Sed non mattis metus vel lorem tincidunt, pharetra eros nec Nullam eget bibendum.</p>
					</div>
					<div class="col-sm-6">
						<h3 class="heading">Outcomes of this Case</h3>
						<p><img src="image/photo-sm-energy-b.jpg" alt=""></p>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pretium orci sit amet mi ullamcorper egestas. Sed non mattis metus. Integer vel lorem tincidunt, pharetra eros nec, posuere odio. Nullam eget bibendum sem, venenatis lacinia justo pretium orci sit amet mi ullam.</p>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pretium orci sit amet mi ullamcorper egestas. Sed non mattis metus vel lorem tincidunt, pharetra eros nec Nullam eget bibendum.</p>
					</div>
				</div>
	...
	<div class="section section-contents section-pad bg-light">
		<div class="container">
			<div class="content row">
					...
					<div class="txt-entry">
						<h3 class="heading">Feature of this Story</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pretium orci sit amet mi ullamcorper egestas. Sed non mattis metus. Integer vel lorem tincidunt, pharetra eros nec, posuere odio. Nullam eget bibendum sem, venenatis lacinia justo pretium orci sit amet mi ullam.</p>
					</div>
					<div class="gaps size-2x"></div>
					<div class="row">
						<div class="col-sm-4 res-s-bttm">
							<div class="bg-white round pd-x3">
								<div class="icon-box style-s2 size-md">
									<em class="fa fa-bolt"></em>
								</div>
								<h5>Surface Protection</h5>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit viverra nec suscipit venenatis.</p>
							</div>
						</div>
						<!-- // -->
						<div class="col-sm-4 res-s-bttm">
