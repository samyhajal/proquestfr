...
<html lang="zxx">
<head>
	<title>Responsibility | Industrial - Industry and Engineering Services Template</title>
	<meta charset="utf-8" />
			...
			<div class="content row">
				...
				<div class="row">
					<div class="col-md-8">
						...
						<p>Making a positive impact on the communities in which we operate is central to our approach in achieving sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Utenim ad minim veniam, quis nostrud exercation ullamco laboris nisi ut aliquip.</p>
						<p>We operate is central to our approach in achieving sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Uminim tenim veniam nostrud exercation ullamco laboris nisi ut aliquip.</p>
						<blockquote>
							<p>It’s really important to us to educate the next tempor incididunt ut labore et dolore magna aliqua. Peiusmod tempor incididunt ut labore et dolore magna aliqua.”</p>
							
							<p>- <strong>Abc Rowe, Owner of Company</strong></p>
						</blockquote>
						<div class="gaps"></div>
						<div class="col-md-6 npl res-m-bttm">
							<h3 class="color-primary">Environment</h3>
							<p><img src="image/photo-sm-oil-c.jpg" alt=""></p>
							<p>Lorem ipsum dolor sit amet, consecteturt adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Promeo ipsum dolor sit amet, consecteturt adipiscing</p>
						</div>

						<div class="col-md-6 npr">
							<h3 class="color-primary">Health &amp; Safety</h3>
							<p><img src="image/photo-sm-mine-d.jpg" alt=""></p>
							<p>Lorem ipsum dolor sit amet, consecteturt adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Promeo ipsum dolor sit amet, consecteturt adipiscing</p>
						</div>
						<div class="clear"></div>
						<div class="gaps size-lg"></div>
						<h3 class="color-primary">Performance Standards</h3>
						<p>Importantly the standard does not articulate in detail ad minim veniam, quis nostrud exercation ullamco laboris nisi ut aliquip. Exed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Uminim tenim veniam nostrud exercation ullamco laboris nisi ut aliquip.</p>
						<p><strong>Safety Performance Standards</strong></p>
						<p><strong>Environmental Performance Standards</strong></p>
						<p><strong>Health Performance Standards</strong></p>
						<p><strong>Social Performance Standards</strong></p>
					</div>
							...
							<div class="wgs-box wgs-menus">
								<div class="wgs-content">
									<ul class="list list-grouped">
										...
										<li><a href="resources.html">Resources</a></li>
										<li class="current"><a href="responsibility.html">Responsibility</a></li>
