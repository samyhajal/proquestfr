...
<html lang="zxx">
<head>
	<title>Carousel | Industrial - Industry and Engineering Services Template</title>
	<meta charset="utf-8" />
	...
	<div class="section section-contents section-pad">
		<div class="container">
			<div class="content row">
				...
				<div class="wide-md al-center">
					<h6 class="heading-sm-lead color-secondary with-line">Gallery with Carousel</h6>
				</div>
				<div class="gaps size-lg"></div>
				<!-- Gallery -->
				<div class="gallery gallery-grids gallery-lightbox hover-zoom mgfix">
					<ul class="gallery-list has-carousel" data-navs="1" data-items="4">
						<li>
							<a href="image/gallery/gallery1-large.jpg">
								<div class="gallery-item"><img src="image/gallery/gallery1.jpg" alt="Name of Photo"></div>
							</a>
						</li>
						<li>
							<a href="image/gallery/gallery2-large.jpg">
								<div class="gallery-item"><img src="image/gallery/gallery2.jpg" alt="Photo Title"></div>
							</a>
						</li>
						<li>
							<a href="image/gallery/gallery3-large.jpg">
								<div class="gallery-item"><img src="image/gallery/gallery3.jpg" alt="Name of Photo"></div>
							</a>
						</li>
						<li>
							<a href="image/gallery/gallery4-large.jpg">
								<div class="gallery-item"><img src="image/gallery/gallery4.jpg" alt="Name of Photo"></div>
							</a>
						</li>
						<li>
							<a href="image/gallery/gallery5-large.jpg">
								<div class="gallery-item"><img src="image/gallery/gallery5.jpg" alt="Name of Photo"></div>
							</a>
						</li>
						<li>
							<a href="image/gallery/gallery6-large.jpg" title="Photo Title">
								<div class="gallery-item"><img src="image/gallery/gallery6.jpg" alt="Name of Photo"></div>
							</a>
						</li>
						<li>
							<a href="image/gallery/gallery7-large.jpg">
								<div class="gallery-item"><img src="image/gallery/gallery7.jpg" alt="Name of Photo"></div>
							</a>
						</li>
						<li>
							<a href="image/gallery/gallery8-large.jpg" title="Photo Title">
								<div class="gallery-item"><img src="image/gallery/gallery8.jpg" alt="Name of Photo"></div>
							</a>
						</li>
					</ul>
				</div>
				...
				<div class="wide-md al-center">
					<h6 class="heading-sm-lead color-secondary with-line">Gallery with Carousel - Autoplay</h6>
				</div>
				<div class="gaps size-lg"></div>
				<!-- Gallery -->
				<div class="gallery gallery-grids gallery-lightbox hover-zoom mgfix">
					<ul class="gallery-list has-carousel" data-navs="1" data-items="4" data-auto="1">
						<li>
							<a href="image/gallery/gallery2-large.jpg">
								<div class="gallery-item"><img src="image/gallery/gallery2.jpg" alt="Name of Photo"></div>
							</a>
						</li>
						<li>
							<a href="image/gallery/gallery1-large.jpg">
								<div class="gallery-item"><img src="image/gallery/gallery1.jpg" alt="Photo Title"></div>
							</a>
						</li>
						<li>
							<a href="image/gallery/gallery3-large.jpg">
				...
				<div class="gaps size-section"></div>
				<div class="wide-md al-center">
					<h6 class="heading-sm-lead color-secondary with-line">Gallery with Carousel - Caption - Loop</h6>
				</div>
				<div class="gaps size-lg"></div>
				<!-- Gallery -->
				<div class="gallery gallery-grids hover-zoom mgfix">

					<ul class="gallery-list has-carousel" data-navs="1" data-loop="1" data-items="3">
						<li>
							<div class="photo">
								<img src="image/gallery/gallery1.jpg" alt="Name of Photo">
								<div class="photo-item-link">
									<span class="link-block">
										<a class="link link-more" href="portfolio-single.html"><em class="fa fa-link"></em></a>
										<a class="link link-popup image-lightbox" href="image/gallery/gallery1-large.jpg" title="Photo Title"><em class="fa fa-arrows-alt"></em></a>
									</span>
								</div>
						...
						<li>
							<div class="photo">
								<img src="image/gallery/gallery2.jpg" alt="Name of Photo">
								<div class="photo-item-link">
									<span class="link-block">
										<a class="link link-more" href="portfolio-single.html"><em class="fa fa-link"></em></a>
										<a class="link link-popup image-lightbox" href="image/gallery/gallery2-large.jpg" title="Photo Title"><em class="fa fa-arrows-alt"></em></a>
									</span>
								</div>
								<div class="photo-item-caption light">
						...
						<li>
							<div class="photo">
								<img src="image/gallery/gallery3.jpg" alt="Name of Photo">
								<div class="photo-item-link">
									<span class="link-block">
										<a class="link link-more" href="portfolio-single.html"><em class="fa fa-link"></em></a>
										<a class="link link-popup image-lightbox" href="image/gallery/gallery3-large.jpg" title="Photo Title"><em class="fa fa-arrows-alt"></em></a>
									</span>
								</div>
								<div class="photo-item-caption dark">
						...
						<li>
							<div class="photo">
								...
								<div class="photo-item-link">
									<span class="link-block">
										<a class="link link-more" href="portfolio-single.html"><em class="fa fa-link"></em></a>
										<a class="link link-popup image-lightbox" href="image/gallery/gallery4-large.jpg" title="Photo Title"><em class="fa fa-arrows-alt"></em></a>
									</span>
								</div>
								<div class="photo-item-caption light">
						...
						<li>
							<div class="photo">
								<img src="image/gallery/gallery5.jpg" alt="Name of Photo">
								<div class="photo-item-link">
									<span class="link-block">
										<a class="link link-more" href="#"><em class="fa fa-link"></em></a>
										<a class="link link-popup image-lightbox" href="image/gallery/gallery5-large.jpg" title="Photo Title"><em class="fa fa-arrows-alt"></em></a>
									</span>
								</div>
								<div class="photo-item-caption light">
									<p class="item-cat">Creative</p>
						...
						<li>
							<div class="photo">
								<img src="image/gallery/gallery8.jpg" alt="Name of Photo">
								<div class="photo-item-link">
									<span class="link-block">
										<a class="link link-more" href="#"><em class="fa fa-link"></em></a>
										<a class="link link-popup image-lightbox" href="image/gallery/gallery8-large.jpg" title="Photo Title"><em class="fa fa-arrows-alt"></em></a>
									</span>
								</div>
								<div class="photo-item-caption light">
				...
				<div class="gaps size-section"></div>
				<div class="wide-md al-center">
					<h6 class="heading-sm-lead color-secondary with-line">Feature Box with Carousel - No Loop</h6>
				</div>
				<!-- Featured Box with Carousel -->
				<div class="feature-row feature-service-row row feature-s4 boxed-filled has-carousel" data-items="3" data-navs="1">
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="feature bg-dark">
							<a href="#">
								...
								<div class="fbox-over">
									<h3 class="title">Chemical Research Engineering</h3>
								</div>
							</a>
						</div>
					</div>
				...
				<div class="gaps size-section"></div>
				<div class="wide-md al-center">
					<h6 class="heading-sm-lead color-secondary with-line">Feature Box with Carousel - Loop</h6>
				</div>
				<!-- Featured Box with Carousel -->
				<div class="feature-row feature-service-row row feature-s4 boxed-filled has-carousel" data-items="3" data-dots="1" data-loop="1">
					...
					<div class="col-md-4 col-sm-4">
						<div class="feature boxed">
							...
							<div class="fbox-content">
								<h3 class="lead"><a href="#">Financial Consulting</a></h3>
					...
					<div class="col-md-4 col-sm-4">
						<div class="feature boxed">
							...
							<div class="fbox-content">
								<h3 class="lead"><a href="#">General Consulting</a></h3>
								<p>Lorem ipsum dolor sit amet, conse ctetur adip isicing elit, sed do eius mod tempor incididunt fuga platea ut labore et.</p>
								<p><a href="#" class="btn-link link-arrow-sm">Learn More</a></p>
							</div>
						</div>
					...
					<div class="col-md-4 col-sm-4">
						<div class="feature boxed">
							...
							<div class="fbox-content">
								<h3 class="lead"><a href="#">Account Audit</a></h3>
								<p>Lorem ipsum dolor sit amet, conse ctetur adip isicing elit, sed do eius mod tempor incididunt fuga platea ut labore et.</p>
								<p><a href="#" class="btn-link link-arrow-sm">Learn More</a></p>
							</div>
						</div>
				...
				<div class="box bg-light pd-x3 round">
					...
					<br>Apply <code>.has-carousel</code> class to enable carousel.
					<br>Addtionally use <code>data-items="4"</code> for how many item visible, <code>data-delay="4000"</code> for time out when carousel autoplay, <code>data-auto="1"</code> for autoplay enable, <code>data-loop="1"</code> for loop carousel, <code>data-dots="1"</code> for visible dots navigation, <code>data-navs="1"</code> for visible next/prev arrow and also <code>data-margin="30"</code> to control margin.</p>
					<div class="small">
<pre>
&lt;ul class="gallery-list <code class="color-secondary">has-carousel</code>" <code class="color-primary">data-items="4"</code> <code class="color-primary">data-navs="1"</code> <code class="color-primary">data-margin="30"</code> <code class="color-primary">data-auto="1"</code>&gt; 
   &lt;li&gt; &lt;/li&gt;
   &lt;li&gt; &lt;/li&gt; 
&lt;/ul&gt;</pre>
					</div>
