...
<html lang="zxx">
<head>
	<title>Projects | Industrial - Industry and Engineering Services Template</title>
	<meta charset="utf-8" />
		...
		<div class="container">
			<div class="content row">
				...
				<div class="wide-sm text-center">
					...
					<p>Nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat do eiusmod tempor incidid. Adipiscing elit sed do eiusmod tempor incididunt bore eter dolore magna aliqua.</p>
				</div>
				...
				<div class="gallery gallery-folio with-caption gallery-filter hover-zoom">
					...
					<ul class="photos-list col-x3">
							...
							<div class="photo">
								...
								<div class="photo-item-link">
									<span class="link-block">
										<a class="link link-more" href="project-single.html"><em class="fa fa-link"></em></a>
										<a class="link link-popup single-lightbox" href="image/gallery/gallery1-large.jpg" title="Photo Title"><em class="fa fa-arrows-alt"></em></a>
									</span>
								</div>
						...
						<li class="filtr-item" data-category="21">
							<div class="photo">
								...
								<div class="photo-item-link">
									<span class="link-block">
										<a class="link link-more" href="project-single.html"><em class="fa fa-link"></em></a>
										<a class="link link-popup single-lightbox" href="image/gallery/gallery2-large.jpg" title="Photo Title"><em class="fa fa-arrows-alt"></em></a>
									</span>
								</div>
								<div class="photo-item-caption light">
						...
						<li class="filtr-item" data-category="11, 31">
							<div class="photo">
								...
								<div class="photo-item-link">
									<span class="link-block">
										<a class="link link-more" href="project-single.html"><em class="fa fa-link"></em></a>
										<a class="link link-popup single-lightbox" href="image/gallery/gallery3-large.jpg" title="Photo Title"><em class="fa fa-arrows-alt"></em></a>
									</span>
								</div>
						...
						<li class="filtr-item" data-category="31">
							<div class="photo">
								...
								<div class="photo-item-link">
									<span class="link-block">
										<a class="link link-more" href="project-single.html"><em class="fa fa-link"></em></a>
										<a class="link link-popup single-lightbox" href="image/gallery/gallery4-large.jpg" title="Photo Title"><em class="fa fa-arrows-alt"></em></a>
									</span>
								</div>
								<div class="photo-item-caption light">
						...
						<li class="filtr-item" data-category="21">
							<div class="photo">
								...
								<div class="photo-item-link">
									<span class="link-block">
										<a class="link link-more" href="project-single.html"><em class="fa fa-link"></em></a>
										<a class="link link-popup single-lightbox" href="image/gallery/gallery5-large.jpg" title="Photo Title"><em class="fa fa-arrows-alt"></em></a>
									</span>
								</div>
								<div class="photo-item-caption light">
									<p class="item-cat">Creative</p>
						...
						<li class="filtr-item" data-category="11, 21">
							<div class="photo">
								<img src="image/gallery/gallery6.jpg" alt="Name of Photo">
								<div class="photo-item-link">
									<span class="link-block">
										<a class="link link-more" href="project-single.html"><em class="fa fa-link"></em></a>
										<a class="link link-popup single-lightbox" href="image/gallery/gallery6-large.jpg" title="Photo Title"><em class="fa fa-arrows-alt"></em></a>
									</span>
								</div>
								<div class="photo-item-caption light">
