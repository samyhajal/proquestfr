		...
		<div class="container">
			<div class="content row">
				...
				<div class="wide-md center">
					<h1>We Offer Our Services</h1>
					<p class="lead">Bring to the table win-win survival strategies to ensure proactive domination.</p>
				...
				<!-- Feature Row  -->
				<div class="feature-row feature-service-row row feature-s4">
					<div class="col-sm-6 even first">
						<!-- feature box -->
							...
							<a href="solution-single.html">
								...
								<div class="fbox-over">
									...
									<div class="fbox-content">
										<p>Agricultural division improves the local agricultural economy by enabling farmers to...</p>
									</div>
								</div>
							</a>
						</div>
						...
						<div class="feature boxed">
							<a href="solution-single-alter.html">
								...
								<div class="fbox-over">
									...
									<div class="fbox-content">
										<p>Chemicals sector expertise covers the full range of unit operations found in the...</p>
									</div>
								</div>
							</a>
						</div>
						...
						<div class="feature boxed">
							<a href="solution-single-extend.html">
								...
								<div class="fbox-over">
									...
									<div class="fbox-content">
										<p>We are responsible for the research and development of materials to advance...</p>
									</div>
								</div>
							</a>
						</div>
						...
						<div class="feature boxed">
							<a href="solution-single-alter.html">
								...
								<div class="fbox-over">
									...
									<div class="fbox-content">
										<p>We apply the principles of engineering, physics, and materials science for...</p>
									</div>
								</div>
							</a>
						</div>
					...
					<div class="col-sm-6 odd">
						...
						<div class="feature boxed">
							<a href="solution-single-alter.html">
								...
								<div class="fbox-over">
									<h3 class="title">Oil and Gas</h3>
									<div class="fbox-content">
										<p>The petroleum industry includes the global processes of exploration, extraction...</p>
									</div>
								</div>
							</a>
						</div>
						...
						<div class="feature boxed">
							<a href="solution-single-alter.html">
								...
								<div class="fbox-over">
									...
									<div class="fbox-content">
										<p>We are specializes in the design of electrical systems for a wide range of...</p>
									</div>
								</div>
							</a>
						</div>
