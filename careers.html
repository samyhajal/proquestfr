...
<html lang="zxx">
<head>
	<title>Careers | Industrial - Industry and Engineering Services Template</title>
	<meta charset="utf-8" />
			...
			<div class="content row">
				...
				<div class="row">
					<div class="col-md-8 res-m-bttm">
						<h2>Together, We're Changing the World</h2>
						<p>Imagine being surrounded by a team dolor sit amet consectetur to adipiscing elit, sed dot eiusmod tempor incididunt labore et dolore magna aliqua. Veniam quis nostrud exercitation ullamco laboris nisiut.</p>
						<p>Search for our current open jobs around the world and apply online. </p>
						<p><a href="#" class="btn">Find Opportunities</a></p>
					</div>
					<div class="col-md-4">
						<div class="box-s4">
				...
				<div class="row">
					<div class="col-md-6 res-m-bttm-sm">
						<div class="box-s1 box-flat-thin">
							...
							<p>Dolor sit amet consectetur to adipiscing elit, sed dot eiusmod tempor incididunt labore et dolore magna aliqua.</p>
			...
			<div class="content row">
				...
				<div class="row">
					<div class="col-sm-4 res-s-bttm-lg">
						...
						<p>We are committed to building the unde omnis iste natus error sit voluptatem accusantium dolore mque laudantium, totam rem aperiam sunt explicabo.</p>
					</div>
					<div class="col-sm-4 res-s-bttm-lg">
