			...
			<div class="content row">
				...
				<div class="row">
					<div class="col-md-8">
						...
						<h1>Oil and Gas Solution</h1>
						<p class="lead">The petroleum industry includes the global processes of exploration, extraction, refining, transporting petroleum products.</p>
						<p>Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Donec id elit non mi porta gravida at eget metus. Curabitur blandit tempus porttitor.</p>
						...
						<h3>We Can Offer Following Types Of Solutions:</h3>
						<p>We are ipsum dolor sit amet enim ad minim veniam, quis nostrud exercation ullamco laboris nisi ution aliquip exon commodo conquat. Duis aute irure dolor nostrud ullamco. Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
						...
						<div class="col-list space-top-md space-bottom-md">
							<div class="row">
								<div class="col-sm-6 col-xs-6">
									<img src="image/photo-sm-oil-a.jpg" alt="" class="aligncenter">
								</div>
								<div class="col-sm-6 col-xs-6">
									<img src="image/photo-sm-oil-b.jpg" alt="" class="aligncenter">
								</div>
							</div> 
						</div>
						<div class="clear"></div>
						...
						<p>Leverage agile frameworks sit amet enim ad minim veniam, quis nostrud exercation ullamco laboris nisi ution aliquip exon commodo conquat. Duis aute irure dolor nostrud ullamco. Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
