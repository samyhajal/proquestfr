	        		...
	        		<div class="col-md-8 res-m-bttm">
						...
						<div class="gallery-lists gallery-product-list alignl filter-menu">
		                    <ul class="list">
		                        ...
		                        <li data-filter="1">Hydraulic</li>
		                        <li data-filter="2">Tools</li>
		                        <li data-filter="3">Others</li>
		                    </ul>
						</div>

						<!-- Product List section (!required 'gallery-filter' class name in gallery & also filter-menu section above) -->
						<div class="gallery gallery-filter gallery-products with-caption hover-fade">
							<ul class="photos-list col-x2">
								<li class="filtr-item" data-category="1">
									<div class="photo">
										...
										<div class="photo-link">
											<span class="links">
												<a class="btn more-link" href="product-single.html">View Product</a>
											</span>
										</div>
									</div>
								...
								<li class="filtr-item" data-category="1, 2">
									<div class="photo">
										<img src="image/product-sm-b.jpg" alt="">
										<div class="photo-link">
											<span class="links">
												<a class="btn more-link" href="product-single.html">View Product</a>
											</span>
								...
								<li class="filtr-item" data-category="3">
									<div class="photo">
										<img src="image/product-sm-c.jpg" alt="">
										<div class="photo-link">
											<span class="links">
												<a class="btn more-link" href="product-single.html">View Product</a>
											</span>
								...
								<li class="filtr-item" data-category="2">
									<div class="photo">
										<img src="image/product-sm-d.jpg" alt="">
										<div class="photo-link">
											<span class="links">
												<a class="btn more-link" href="product-single.html">View Product</a>
											</span>
